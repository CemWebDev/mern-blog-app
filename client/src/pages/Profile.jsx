      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            ...
            {updateError && (
              <div className="mb-4 text-sm text-rose-700 bg-rose-50 border border-rose-200 rounded-sm p-3">
                {updateError}
              </div>
            )}
              ...
              <div>
                {isEditing ? (
                  ...
                  <div>
                    ...
                    <div className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-sm text-gray-900">
                      {profile.username}
                      {isGitHubUser && (
              ...
              <div className="pt-6 border-t border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-sm text-sm text-gray-600 font-mono">
                      {profile.id}
                    </div>
                  </div>
                  {isGitHubUser && (
